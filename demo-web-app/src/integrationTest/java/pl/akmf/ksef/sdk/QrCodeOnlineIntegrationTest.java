...
public class QrCodeOnlineIntegrationTest extends BaseIntegrationTest {
    private int SESSION_SUCCESSFUL_STATUS_CODE = 200;
    private int SESSION_FAILED_STATUS_CODE = 445;
     ...
     */
    @Test
    public void qrCodeOnlineE2ETest() throws JAXBException, IOException, ApiException, CertificateException, WriterException {
        ...
        String invoiceReferenceNumber = sendInvoiceOnlineSession(contextNip, sessionReferenceNumber, encryptionData, cryptographyService, "/xml/invoices/sample/invoice-template.xml", accessToken);
    ...
    private SessionStatusResponse getSessionStatusResponse(String sessionReferenceNumber, String accessToken) throws ApiException {
        return createKSeFClient().getSessionStatus(sessionReferenceNumber, accessToken);
    }
    ...
    private SessionInvoiceStatusResponse getSessionInvoiceStatus(String sessionReferenceNumber, String invoiceReferenceNumber, String accessToken) throws ApiException {
        return createKSeFClient().getSessionInvoiceStatus(sessionReferenceNumber, invoiceReferenceNumber, accessToken);
    }
